# MiID Document Validation Api

![N|Solid](https://miid.bio/wp-content/uploads/2021/06/MiID_ico-100x100.png)

**MiID Document Validation** is an API that provides the functionality to connect your platform or system to MiID Gateway Service 
...
## Operations
 ...
 - [Validate Doc Person Async](#ValidateDocPersonAsync)

**MiID Document Validation**  is a commercial Service, to use it contact [info@bytte.com.co](mailto:info@bytte.com.co) for instructions on how to obtain the required resources and access
...
```
-------
## <a name="ValidateDocPersonAsync"></a>Validate Doc Person Async
